...
@Constraint(validatedBy = {PointTodoDateIdValidationImpl.class})
public @interface PointTodoDateIdValidation {
    String message() default "Todo Date ID validation error ";
