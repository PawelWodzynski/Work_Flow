                ...
                <div class="modal-body border rounded-3 border-warning text-white bg-dark">
                    <div class="row mb-3">
                        ...
                        <div class="col-4 d-flex justify-content-center">
                            <div class="dropdown">
                                <button id="pointDropdownButton-${todoPointId}" type="button" class="btn btn-warning dropdown-toggle text-center" data-bs-toggle="dropdown">
                                    Task Deadline
                                </button>
                                <ul id="pointModalDropdown-${todoPointId}" class="dropdown-menu modal-dropdown-list-height overflow-auto">
                        ...
                        <div class="col-4 d-flex justify-content-end">
                            <div class="btn-group">
                                ...
                                <button id="closePointModalButton-${todoPointDate}" class="btn btn-danger" data-bs-dismiss="modal">
